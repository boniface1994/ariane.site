                    ...
                    <div class="input-group">
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <div class="form-group col-md-12" style="background-color: black;color: white;">
                                    <div class="input-group">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            @if(session('cubesat'))
                                                <h4>{{strtoupper(session('cubesat')) }}</h4>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="input-group">
                                        <div class="form-group col-md-3">
                                            <label class="form-label text-white">Orbit</label>
                                            <h4>SSO</h4>
                                        </div>
                                        <div class="form-group col-md-9">
                                            <label class="form-label text-white">Expected launch</label>
                                            <h4>Q2.2024</h4>
                                        </div>
                                    </div>
                                    <div class="input-group"> 
                                        ...
                                        <div class="form-group">
                                            <a class="btn btn-warning text-dark">Contact us</a>
                                        </div>
                                    </div>
                                </div> 
                            </div>
